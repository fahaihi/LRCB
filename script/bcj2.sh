#!/bin/bash
# 运行脚本
# nohup srun -p gpu1 -N 1 -c 16 ./bcj2.sh > /public/home/jd_sunhui/genCompressor/LRCB/result/bcj2_16.out &
...
for SourceDataDir in $F_NAME; do
  ...
  echo "compression..."
  (/bin/time -v -p 7zz a -m0=bcj2 -mx9 -mmt${threads} ${FileBaseName}.7z ${FileBaseName}.reads) >${FileBaseName}_${threads}_com.log 2>&1
  echo "统计压缩信息"
